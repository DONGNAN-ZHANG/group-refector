        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContend">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link ml-3" href="#">Features</a>
                </li>
                <li class="nav-item active">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="#">Popluars of the day</a>
                        <a class="dropdown-item" href="#">Popluars of the Weed</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#">View the gallary</a>
                    </div>
                </li>
                <li class="nav-item active">
                    <a class="nav-link ml-2" href="#">Register</a>
                </li>
                <li class="nav-item">
